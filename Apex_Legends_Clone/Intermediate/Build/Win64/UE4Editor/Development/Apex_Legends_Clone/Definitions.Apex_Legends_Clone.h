...
#define ORIGINAL_FILE_NAME "UE4Editor-Apex_Legends_Clone.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_PROJECT_NAME Apex_Legends_Clone
...
#define APEX_LEGENDS_CLONE_API DLLEXPORT
